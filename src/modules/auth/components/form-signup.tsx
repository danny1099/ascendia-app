...
import { Input, Button, InputPassword, Separator } from "@/shared/components";
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <div className="flex h-auto w-full flex-col gap-3 py-2">
            ...
            />
            <Button type="submit" className="mt-4 w-full" icon="arrowRight" isLoading={formState.isSubmitting}>
