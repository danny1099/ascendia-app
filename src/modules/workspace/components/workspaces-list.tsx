...
import { AnimatedContent, Box, EmptyData, Icon, IconName, SearchBox } from "@/shared/components";
            ...
            <Table>
              ...
              <TableBody>
                {filteredWorkspaces.map((workspace) => {
                  return (
                    <TableRow key={workspace.id} className="group hover:text-tertiary hover:bg-accent/60">
